...
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { right }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { left }]; #IO_L7P_T1_34 Sch=btn[3]
